...
contenido = [
    ...
    ['3.', 'NÚMERO DE CONTRATO:', 'SAT-GRRHH-096-2024', ''],
    ...
    ['7.', 'VIGENCIA DE CONTRATO:', 'DEL: 03/01/2024', 'AL: 30/11/2024'],
...
for i, row_content in enumerate(contenido):
    for j, cell_content in enumerate(row_content):
        cell = table.cell(i, j)
        cell.paragraphs[0].paragraph_format.space_after = Pt(5)  # Establecer espacio después a cero
        cell.vertical_alignment = WD_ALIGN_VERTICAL.CENTER

        if i in [0, 1, 2, 3, 4, 5, 8]:  # Filas a fusionar
            cell.paragraphs[0].paragraph_format.space_after = Pt(5)  # Restablecer espacio después
...
ruta_carpeta_html = "C:/Users/acapaizlo/Desktop/Junio"

# Carpeta de imágenes
ruta_carpeta_imagenes = "C:/Users/acapaizlo/Pictures/Screenshots/Junio"
...
document.save('C:/Users/acapaizlo/Desktop/informeprueba.docx')
#abrir el documento
os.startfile('C:/Users/acapaizlo/Desktop/informeprueba.docx')